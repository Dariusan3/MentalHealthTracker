...
namespace MentalHealthTracker.Migrations
{
    ...
    [Migration("20250528233506_AddChatConversations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MentalHealthTracker.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("LastMessageResetDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("MessagesLeftToday")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MentalHealthTracker.Models.ChatConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MentalHealthTracker.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MentalHealthTracker.Models.ChatMessage", b =>
                {
                    b.HasOne("MentalHealthTracker.Models.ChatConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MentalHealthTracker.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
